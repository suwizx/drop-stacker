...
dependencies {
	...
	// Loom 1.17 has no modImplementation: intermediary is 0.0.0 for this Minecraft
...
java {
	// Minecraft 26.3 runs on Java 25. Pinning the toolchain means compilation and the run tasks all
